  ...
  return [
    {
      ...
      // Ids match the role map, the trusted list and the skipped channel below,
      // so every setting on the fixture resolves to a name.
      channels: [
        { id: "742118990011224200", name: "general" },
        { id: "742118990011224201", name: "lfg" },
        { id: "742118990011224202", name: "clips" },
        { id: "742118990011224203", name: "voice-text" },
        { id: "742118990011223999", name: "mod-alerts" },
        { id: "742118990011224100", name: "staff-lounge" },
      ],
      roles: [
        { id: "742118990011224003", name: "Moderators" },
        { id: "742118990011224002", name: "Older Teens" },
        { id: "742118990011224001", name: "Teens" },
        { id: "742118990011224004", name: "Adults" },
        { id: "742118990011224005", name: "Parents" },
      ],
