...
docs/              DESIGN.md (spec), design.html (generated by `pnpm docs`, never edited), ADRs as they happen.
```
...
- Roblox PII Classifier v2: https://huggingface.co/Roblox/roblox-pii-classifier-v2 (weights available). Benchmark: https://huggingface.co/datasets/Roblox/roblox-pii-classifier-benchmark (the same repo was previously named roblox-pii-safety-for-chat-benchmark; there is one dataset, not two)
