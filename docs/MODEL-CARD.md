...
- The known-contact population, deliberately and permanently for version 1. Thorn's June 2025 survey (n=1,200 youth) found 36% of sextortion victims knew the perpetrator offline; of those, 52% were current or former romantic partners and 54% of perpetrators were themselves minors, and threats were carried out 38% of the time against 20% online-only. So this population is both large and, on that last number, worse. Guardian's decisive signals (new account, catfish profile, threat template, off-platform migration, age gap) do not fire on it, and the two things that partly reach it are the non-financial coercion detector and the support posture that keeps a minor-band account out of an enforcement path. Covering it properly needs a different signal set and labelled data that does not exist. Anyone quoting Guardian's recall should read it as recall over the stranger and financial pattern, not over sextortion.
